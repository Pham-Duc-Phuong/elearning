...
export const Password = () => {
    ...
    return (
        <form className="mt-[10px]" onSubmit={handleSubmit(setSubmit)}>
            <Input className="input" label="Mật khẩu hiện tại" placeholder="Mật khẩu" id="matKhau" error={errors?.matKhau?.message} register={register} />
            <Input className="input" label="Mật khẩu mới" placeholder="Mật khẩu mới" id="matKhauChange1" error={errors?.matKhauChange1?.message} register={register} />
            <Input className="input" label="Nhập lại mật khẩu mới" placeholder="Nhập lại mật khẩu mới" id="matKhauChange2" error={errors?.matKhauChange2?.message} register={register} />
