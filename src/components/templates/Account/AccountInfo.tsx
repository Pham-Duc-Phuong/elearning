...
export const AccountInfo = () => {
    ...
    return (
        <form className="mt-[10px]" onSubmit={handleSubmit(setSubmit)}>
            ...
            <Input colorLabel="black" className="input pointer-events-none !text-gray-400" label="Email" placeholder="Email" id="email" error={errors?.email?.message} register={register} />
            <Input colorLabel="black" hidden={true} type="password" className="input pointer-events-none !text-gray-400" label="Mật khẩu" placeholder="Mật khẩu" id="matKhau" error={errors?.matKhau?.message} register={register} />
